...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form class="form form-horizontal" action="" method="" id="form form-horizontal">
            <div class="row cl">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/dmm/jquery.validate.min.js" ></script>
<script>
